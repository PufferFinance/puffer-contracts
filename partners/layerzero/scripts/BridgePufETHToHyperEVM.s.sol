...
import { pufETHAdapter } from "../contracts/pufETHAdapter.sol";
import { OFTCore } from "@layerzerolabs/oft-evm/contracts/OFTCore.sol";

//Command to run:
//    forge script scripts/BridgePufETHToHyperEVM.s.sol:SendOFT --rpc-url https://mainnet.gateway.tenderly.co/3duIN2qddEFm4vg5rEkX95 -vvvvv
contract SendOFT is Script {
    ...
    function generateCallData(
        ...
        pufETHAdapter sourceOFT = pufETHAdapter(oftAddress);
    ...
    function run() public {
        address oftAddress = 0xa4931a9F9Aaf79057334371D6f62164743f97b18; //pufETHAdapter address
        uint32 dstChainId = 30377; // 30377 is the endpoint ID for the tac-mainnet chain

        // ----------TO CHANGE----------
        address toAddress = 0x1BfAec64abFddcC8c5dA134880d1E71f3E03689E; //recipient address
        uint256 _tokensToSend = 0.007 ether; //amount to send; you can also decimal ether like 1.2 ether
        // ----------TO CHANGE----------
        ...
        console.log(
            string.concat(
                ...
                " --value ",
                vm.toString(fee),
                " --rpc-url https://mainnet.gateway.tenderly.co/3duIN2qddEFm4vg5rEkX95 --ledger --hd-path 'm/44'/60'/21'/0/0'"
            )
        );
    }
