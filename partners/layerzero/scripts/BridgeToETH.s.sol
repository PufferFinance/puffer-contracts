...
import { PUFFER } from "../contracts/PUFFER.sol";
import { OFTCore } from "@layerzerolabs/oft-evm/contracts/OFTCore.sol";

//Command to run:
//  forge script scripts/BridgeToETH.s.sol:SendOFT --rpc-url https://bsc-dataseed.binance.org -vvvvv
...
// }
    ...
    function generateCallData(
        ...
        PUFFER sourceOFT = PUFFER(oftAddress);
    ...
    function run() public {
        address oftAddress = 0x87d00066cf131ff54B72B134a217D5401E5392b6; //PUFFER address
        ...
        uint256 _tokensToSend = 100 ether; //amount to send; you can also decimal ether like 1.2 ether or 100 ether or 
        // ----------TO CHANGE----------
        ...
        console.log(string.concat("cast call ", toHexString(uint160(oftAddress)), " ", toHexString(bytes(callData)), " --value ", vm.toString(fee), " --rpc-url https://bsc-dataseed.binance.org --ledger --hd-path 'm/44'/60'/21'/0/0'"));
    }
