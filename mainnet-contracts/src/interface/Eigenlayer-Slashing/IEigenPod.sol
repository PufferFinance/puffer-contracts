...
interface IEigenPod is IEigenPodErrors, IEigenPodEvents, ISemVerMixin {
    ...
    /// To save gas on checkpoint creation, we don't delete checkpoints when they're completed.
    /// If there's not an active checkpoint, this method returns an empty Checkpoint.
