...
contract TimelockTest is Test {
    ...
    function test_initial_access_manager_setup(address caller) public view {
    ...
    function test_execute_fails_due_to_gas() public {
        ...
        timelock.queueTransaction(address(this), callData, operationId);
    ...
    function gasConsumingFunc() external view {
