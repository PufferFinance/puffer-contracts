...
contract UpgradePufferModule is BaseScript {
    ...
    PufferProtocol pufferProtocol =
        PufferProtocol(payable(0xE00c79408B9De5BaD2FDEbB1688997a68eC988CD)); 
    ...
    IDelayedWithdrawalRouter eigenWithdrawalRouter =  IDelayedWithdrawalRouter(0x642c646053eaf2254f088e9019ACD73d9AE0FA32);
